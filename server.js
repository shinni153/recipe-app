...
- ingredients: 같은 재료가 다른 용도로 사용되면 "버터 (반죽용)", "버터 (마무리용)" 처럼 용도를 괄호로 표시해서 구분해줘
- steps: 재료 분량 숫자는 적지 마. "밀가루 200g을 넣고" → "밀가루를 넣고" 처럼 재료 이름만 언급해줘
- servings: 영상에서 인분 수를 찾을 수 없으면 "1인분"으로 표시해줘
